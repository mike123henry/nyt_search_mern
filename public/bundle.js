...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
	  ...
	  getIitialState: function getIitialState() {
	    return {
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            'New York Times Search using full MERN stack, Save and Comment'
	          ),
	          React.createElement(
	            'h3',
	            { className: 'text-center' },
	            'You can Search a topic of your choice, Save articles that interest you and Comment on those articles'
	          )
	        ),
	        React.createElement(
	          'div',
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    ...
	                    React.createElement('input', { type: 'text', className: 'form-control text-center', id: 'searchTopic', onChange: this.handleChange, required: true }),
